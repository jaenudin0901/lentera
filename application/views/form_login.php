...
<body class="bg-gradient-primary">
            ...
            <div class="row">
              ...
              <div class="col-lg">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="<?php echo base_url('auth/login'); ?>">
                    <div class="form-group">
                      ...
                      <?php echo form_error('username','<div class="text-danger small ml-3"> </dvi>'); ?>                      </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" id="password" name="password" placeholder="Password">
                           <?php echo form_error('password','<div class="text-danger small ml-3"> </dvi>'); ?>                     </div>
                ...
                <button type="submit" class="btn btn-primary btn-user btn-block">Login</button>                 
                  ...
                  <div class="text-center">
                    <a class="small" href="http://localhost/wpu-login/auth/forgotpassword">Forgot Password?</a>
                  </div>
                  <div class="text-center">
                    <a class="small" href="http://localhost/wpu-login/auth/registration">Create an Account!</a>
                  </div>
                </div>
              </div>
            </div>
  ...
  <script src="http://localhost/wpu-login/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
